...
CATEGORIZED_TEST_QUESTIONS = [
    {"question": "What is my conversion funnel for last week? Show it in charts", "queryType": "read", "category": "breeze"},
    {"question": "How much revenue did I process through Cards/UPI/Netbanking/COD/Others yesterday? Show it in charts", "queryType": "read", "category": "juspay"},
    {"question": "What is my conversion rate this month?", "queryType": "read", "category": "breeze"},
    {"question": "What is the source of my leads last week? Show it in charts", "queryType": "read", "category": "marketing"},
    {"question": "Can you provide marketing channel performance for this month? Show it in charts", "queryType": "read", "category": "marketing"},
    ...
    {"question": "What is the daily trend for transaction success rates over the past week? Show it in charts", "queryType": "read", "category": "juspay"},
    {"question": "What is the SR for different payment methods this week? Show it in charts", "queryType": "read", "category": "juspay"},
    {"question": "What is the breakdown of payment methods last month? Show it in charts", "queryType": "read", "category": "juspay"},
    ...
    {"question": "What's the forecast for sales based on the last 3 months data? Show it in charts", "queryType": "read", "category": "analytics"},
    ...
    {"question": "How many orders did I receive this week compared to last week? Show it in charts", "queryType": "read", "category": "breeze"},
    {"question": "What regions have the highest sales last month? Show it in charts", "queryType": "read", "category": "breeze"},
    {"question": "Which regions are we getting the most orders from this month? Show it in charts", "queryType": "read", "category": "breeze"},
    {"question": "How many customers made a repeat purchase last month?", "queryType": "read", "category": "breeze"},
    {"question": "Identify my top 10 most loyal customers based on purchase frequency in the last 6 months? Show it in charts", "queryType": "read", "category": "breeze"},
    {"question": "How many new customers did I acquire this week?", "queryType": "read", "category": "breeze"},
    {"question": "Which payment gateway is performing best in terms of success rates this month? Show it in charts", "queryType": "read", "category": "juspay"},
    {"question": "How many abandoned carts did I have yesterday and what's their estimated value?", "queryType": "read", "category": "breeze"},
    {"question": "iOS/Android - Device specific data for last week. Show it in charts", "queryType": "read", "category": "breeze"},
    {"question": "What is my Avg. number of orders per customer last month", "queryType": "read", "category": "breeze"},
    {"question": "What are my top 10 most bought products this month? Show it in charts", "queryType": "read", "category": "breeze"},
    ...
    {"question": "What was my sales growth this year compared to last year? Show it in charts", "queryType": "read", "category": "breeze"},
    ...
    {"question": "Can you provide order analytics for the currently configured offers last week? Show it in charts", "queryType": "read", "category": "breeze"},
    {"question": "Can you initiate a refund for order ID ORD54321", "queryType": "write", "category": "breeze"},
    {"question": "What are my refund analytics yesterday? Show it in charts", "queryType": "read", "category": "breeze"},
    {"question": "Can you bifurcate sales/SR basis payment method for last week. Provide more analytics like debit card, VPA, QR code. Show it in charts", "queryType": "read", "category": "juspay"},
    ...
    {"question": "How many people applied offer SAVE20 during checkout last week? (Give as a percentage of total orders) Show it in charts", "queryType": "read", "category": "breeze"},
    {"question": "How many carts used offers this week? Show it in charts", "queryType": "read", "category": "breeze"},
    {"question": "How does offer affect their AOV and likelihood to purchase again last month? Show it in charts", "queryType": "read", "category": "breeze"},
    {"question": "What is our Average Order Value (AOV) for first-time customers versus returning customers last quarter? Show it in charts", "queryType": "read", "category": "breeze"},
    {"question": "Can you disable PayU as a PG", "queryType": "write", "category": "juspay"},
    {"question": "What were the peak sales hours yesterday? Show it in charts", "queryType": "read", "category": "breeze"},
    ...
    {"question": "What products have the highest sell through rate last month? Show it in charts", "queryType": "read", "category": "breeze"},
    {"question": "Which landing page is most visited by users first this week?", "queryType": "read", "category": "breeze"},
    {"question": "How many orders were serviced through Standard, Express or any other shipping method last week? Show it in charts", "queryType": "read", "category": "breeze"},
    {"question": "How many products do I currently have in my store? Active/inactive?", "queryType": "read", "category": "breeze"},
    {"question": "How many of my orders are fulfilled? How many unfulfilled? How many partially fulfilled today? Show it in charts", "queryType": "read", "category": "breeze"},
    {"question": "What has been the reach and impact of my campaigns last week? Show it in charts", "queryType": "read", "category": "marketing"},
    {"question": "Can you comment on the effectiveness of campaign SUMMER2024 from last month? Show it in charts", "queryType": "read", "category": "marketing"},
    {"question": "Which is the best performing adset this week? Show it in charts", "queryType": "read", "category": "marketing"},
    {"question": "How much amount have I spent on the ads last month?", "queryType": "read", "category": "marketing"},
    {"question": "How many campaigns did I run in the last 6 months? Show it in charts", "queryType": "read", "category": "marketing"},
    {"question": "Which campaign has the highest spend but lowest ROAS last quarter? Show it in charts", "queryType": "read", "category": "marketing"},
    {"question": "Show me the checkout behavior of customers who came from our Instagram ads versus those from Google Search last week. Show it in charts", "queryType": "read", "category": "marketing"},
    {"question": "Are new users converting better or returning users this month? Show it in charts", "queryType": "read", "category": "marketing"},
    {"question": "What time of day are ads converting best this week? Show it in charts", "queryType": "read", "category": "marketing"},
    {"question": "Suggest the top 3 performing campaigns I should scale based on last month's data. Show it in charts", "queryType": "write", "category": "marketing"},
    {"question": "Compare Google vs Meta performance last week. Show it in charts", "queryType": "read", "category": "marketing"},
    ...
    {"question": "What is the split of sales across the channels - Online store, Buy Button, Social media etc on Shopify? Show it in charts", "queryType": "read", "category": "shopify"},
    ...
    {"question": "Compare my Shopify sales to Yesterday, Last week, last month, previous quarter, previous year. Show it in charts", "queryType": "read", "category": "shopify"},
    {"question": "Give me Shopify sales breakdown - Gross sales, Discounts, Returns, Net sales, Shipping charges, Return fees, Taxes, Total sales. Show it in charts", "queryType": "read", "category": "shopify"},
    {"question": "What is my Total sales by product on Shopify? (Total sales, broken down by product. Total sales = net sales + additional fees + duties + shipping charges + taxes) Show it in charts", "queryType": "read", "category": "shopify"},
    {"question": "What is my Shopify Sessions by location? (Sessions in your online store, broken down by geographic location) Show it in charts", "queryType": "read", "category": "shopify"},
    {"question": "What is Total sales by social referrer split on Shopify? (Total sales from social sources, broken down by name) Show it in charts", "queryType": "read", "category": "shopify"},
    {"question": "What is my Shopify Sessions by landing page breakdown? (Sessions in your online store, broken down by the page the user first landed on) Show it in charts", "queryType": "read", "category": "shopify"},
    {"question": "What split of Sales attributed to marketing on Shopify? (Sales from trackable marketing efforts) Show it in charts", "queryType": "read", "category": "shopify"},
    ...
    {"question": "What are the Shopify orders in Payment status - Pending/Paid/Expired/Voided? Show it in charts", "queryType": "read", "category": "shopify"},
]
