...
BREEZE_BUDDY_TEST_SHOPIFY_SHOP_URL = os.getenv("BREEZE_BUDDY_TEST_SHOPIFY_SHOP_URL", "")
BREEZE_BUDDY_TEST_SHOPIFY_ADMIN_TOKEN = os.getenv("BREEZE_BUDDY_TEST_SHOPIFY_ADMIN_TOKEN", "")

# Session idle timeout
AUTOMATIC_SESSION_IDLE_TIMEOUT = float(os.environ.get("AUTOMATIC_SESSION_IDLE_TIMEOUT", 900.0))